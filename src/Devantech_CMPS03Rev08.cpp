...
#include "Devantech_CMPS03Rev08.h"

const uint8_t REG_CALIBRATE_DONE = 14;
const uint8_t REG_CALIBRATE_CMD = 15;


Devantech_Compass::CompassStatus Devantech_CMPS03Rev08::doCalibration(CompassPoint cp)
{
  if(cp==CP_DEFAULT)
  {
    int i; 
...
Devantech_Compass::CompassCaps Devantech_CMPS03Rev08::getCaps()
{
